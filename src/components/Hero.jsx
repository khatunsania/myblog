		...
		<div className="bg-[url('/src/assets/hero-three.jpg')] w-[100%]  md:w-[100%] ">
			<div className="w-[70%] m-auto py-40 lg:flex lg:justify-between md:block ">
				<div className="lg:w-[40%] md:w-[100%] w-[100%]">
					...
					<h1 className="lg:text-5xl md:text-4xl text-2xl lg:leading-snug		 w-[100%]   text-[#fff] font-bold ">
					...
					<div>
						<ul className="flex ">
							<li className="flex pr-4">
								...
								<span className="pl-1 text-[#cd8a72] lg:text-base md:text-base sm:text-sm text-[12px] lg:mt-0 md:mt-0 mt-1">
									{" "}
									23 Mar,2024
								</span>
							</li>
